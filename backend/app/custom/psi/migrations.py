...
@custom_migration
async def psi_create_tables(conn) -> None:
    await safe_execute(
        conn,
        "CREATE TABLE IF NOT EXISTS psi_material_prices (material VARCHAR(50) PRIMARY KEY, cost_per_kg FLOAT NOT NULL)",
    )
