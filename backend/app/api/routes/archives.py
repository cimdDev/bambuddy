...
async def get_archive_stats(
    ...
    weight_partial_percent = round(max(0.0, 100.0 - weight_psi_percent - weight_private_percent), 1) if total_weight else 0.0
    ...
    cost_partial_percent = round(max(0.0, 100.0 - cost_psi_percent - cost_private_percent), 1) if total_material_cost else 0.0
