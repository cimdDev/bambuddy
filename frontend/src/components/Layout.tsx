...
import { Printer, Archive, Calendar, BarChart3, Cloud, Settings, Sun, Moon, ChevronLeft, ChevronRight, Keyboard, Github, GripVertical, ArrowUpCircle, Wrench, FolderKanban, FolderOpen, Layers, X, Menu, Info, Plug, Bug, LogOut, Key, Loader2, Disc3, type LucideIcon } from 'lucide-react';
...
export const defaultNavItems: NavItem[] = [
  ...
  { id: 'orders', to: '/orders', icon: Layers, labelKey: 'nav.orders' },
