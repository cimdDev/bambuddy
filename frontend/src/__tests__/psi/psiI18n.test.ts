...
const SAME_EVERYWHERE = new Set(['class.psi', 'class.short.psi', 'stats.job.psi', 'accounting.date', 'accounting.weight', 'entity.library', 'entity.archive', 'accounting.user', 'accounting.byUser', 'stats.weight', 'prices.material']);
