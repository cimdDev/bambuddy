export default {
  ...
  queue: {
    ...
    badges: {
      ...
      slicerUserMissingWarning: 'Bitte nur AIK Drucker Profil verwenden',
    },
    editSlicerUser: {
      title: 'Userbadge setzen',
      description: 'Trage das korrekte Userbadge fuer diesen Queue-Eintrag ein. Du kannst einen Badge-Namen oder eine E-Mail-Adresse verwenden.',
      label: 'Userbadge',
      placeholder: 'dein Benutzerkürzel',
      ...
      unsupported: 'Dieser Queue-Eintrag kann nicht aktualisiert werden',
    },
    accounting: {
      privateJob: 'Privater Auftrag',
      privateMaterial: 'Privates Material',
  ...
  uploadModal: {
    ...
    missingUserBadgeWarning: '{{count}} hochgeladene Datei hat kein Userbadge. Du kannst es direkt im Queue-Badge nachtragen.',
