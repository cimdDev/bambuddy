export default {
  ...
  archives: {
    ...
    toast: {
      ...
      failedUpdateArchive: 'Fehler beim Aktualisieren des Archivs',
  ...
  queue: {
    ...
    editSlicerUser: {
      title: 'Userbadge setzen',
      description: 'Trage das korrekte Userbadge fuer diesen Druck ein. Du kannst einen Badge-Namen oder eine E-Mail-Adresse verwenden.',
      label: 'Userbadge',
      placeholder: 'dein Userbadge',
      addMissing: 'Fehlendes Userbadge setzen',
      editExisting: 'Userbadge bearbeiten',
  ...
  stats: {
    ...
    privatePsiAccounting: 'PSI / Privat Abrechnung',
    privatePsiJobs: 'Anteil privater Aufträge',
    privateCount: '{{count}} privat',
    privateWithPartialWeight: 'Privat {{private}} • Teilweise {{partial}}',
    privateWithPartialCost: 'Privat {{private}} • Teilweise {{partial}}',
    psiPercentPrivatePercent: 'PSI {{psi}}% • Privat {{private}}%',
    materialWeightSplit: 'Materialgewicht Aufteilung',
    materialCostSplit: 'Materialkosten Aufteilung',
    psiPrivatePartialWeightValues: 'PSI {{psi}} • Privat {{private}} • Teilweise {{partial}}',
    psiPrivatePartialCostValues: 'PSI {{psi}} • Privat {{private}} • Teilweise {{partial}}',
    psiLabel: 'PSI',
    privateLabel: 'Privat',
  ...
  printerFiles: {
    ...
    importButton: 'Nach Bambuddy importieren',
    moveButton: 'Nach Bambuddy verschieben',
    printButton: 'Drucken',
    scheduleButton: 'Druck planen',
    deleteButton: 'Löschen',
    ...
    toast: {
      imported: '{{count}} Datei(en) nach Bambuddy importiert',
      moved: '{{count}} Datei(en) nach Bambuddy verschoben',
      movedPartial: '{{count}} Datei(en) importiert; einige Quelldateien konnten nicht gelöscht werden',
      printReady: 'Datei importiert und Druckdialog geöffnet',
      queueReady: 'Datei importiert und Warteschlangendialog geöffnet',
      importFailed: 'Import fehlgeschlagen: {{error}}',
      importFailedCount: '{{count}} Datei(en) konnten nicht importiert werden',
      moveDeleteFailed: 'Dateien importiert, aber {{count}} Quelldatei(en) konnten nicht gelöscht werden',
  ...
  uploadModal: {
    ...
    missingUserBadgeWarning: '{{count}} hochgeladene Datei hat kein Userbadge. Du kannst es jetzt korrigieren.',
    confirmMissingUserBadge: 'Im 3MF fuer "{{name}}" wurde kein Userbadge gefunden. Bitte jetzt bestaetigen oder korrigieren.',
    confirmMissingUserBadgeHint: 'Vorschlag aus deinen meistgenutzten Uploads: {{user}}',
