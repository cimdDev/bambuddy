export default {
  ...
  archives: {
    ...
    card: {
      ...
      objects: '{{count}} 个对象',
      privateJob: '私人任务',
      privateMaterial: '私人材料',
      reimbursementDue: '应补：{{amount}}',
  ...
  queue: {
    ...
    badges: {
      ...
      slicerUserMissingWarning: '请仅使用 AIK 打印机配置文件',
    },
    accounting: {
      privateJob: '私人任务',
      privateMaterial: '私人材料',
      companyMaterial: 'PSI 材料',
      privateMaterialPartial: '私人材料（部分）',
      privateMaterialFull: '私人材料（全部）',
      totalCost: '成本：{{amount}}',
      reimbursementDue: '应补：{{amount}}',
    },
    // Empty state
  ...
  stats: {
    ...
    privatePsiAccounting: 'PSI / 私人统计',
    privatePsiJobs: '私人任务占比',
    privateCount: '{{count}} 个私人',
    privateWithPartialWeight: '私人 {{private}} • 部分 {{partial}}',
    privateWithPartialCost: '私人 {{private}} • 部分 {{partial}}',
    psiPercentPrivatePercent: 'PSI {{psi}}% • 私人 {{private}}%',
    materialWeightSplit: '材料重量分布',
    materialCostSplit: '材料成本分布',
    psiPrivatePartialWeightValues: 'PSI {{psi}} • 私人 {{private}} • 部分 {{partial}}',
    psiPrivatePartialCostValues: 'PSI {{psi}} • 私人 {{private}} • 部分 {{partial}}',
    psiLabel: 'PSI',
    privateLabel: '私人',
    partialLabel: '部分',
    timeframe: {
  ...
  editArchive: {
    ...
    accounting: {
      title: '核算',
      privateJob: '私人任务',
      privateMaterial: '使用私人材料打印（全部）',
      privateMaterialPartial: '使用私人材料打印（部分）',
    },
    saving: '保存中...',
    // Failure reasons
    failureReasons: {
