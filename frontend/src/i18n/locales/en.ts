export default {
  ...
  // Orders (OrderBatch / PrintBatch MVP)
  orders: {
    title: 'Orders',
    subtitle: 'Plate-level batch planning on top of the existing queue.',
    newOrder: 'New Order',
    closeCreate: 'Close',
    createFromLibraryFile: 'Create Order from Library File',
    orderName: 'Order Name',
    orderNamePlaceholder: 'Customer batch / job name',
    libraryFileId: 'Library File ID',
    libraryFileIdPlaceholder: 'e.g. 37',
    preview: 'Preview',
    previewing: 'Previewing...',
    detectedPlates: 'Detected plates: {{count}}',
    dueDateOptional: 'Due Date (optional)',
    notesOptional: 'Notes (optional)',
    notesPlaceholder: 'Customer / production notes',
    createOrder: 'Create Order',
    creatingOrder: 'Creating Order...',
    orderList: 'Order List',
    loadingOrders: 'Loading orders...',
    noOrders: 'No orders yet.',
    createValidationError: 'Name and a valid Library File ID are required.',
    previewFailed: 'Failed to load plate preview',
    ...
    dispatchRemaining: 'Dispatch Remaining',
    dispatchPlate: 'Dispatch Plate',
    dispatch: 'Dispatch',
    dispatchLimitPlaceholder: 'limit',
    collapse: 'Collapse',
    expand: 'Expand',
    progressSummary: 'Progress Summary',
    summary: {
      quantity_target: 'Target Qty',
      queued_runs: 'Queued',
      printing_runs: 'Printing',
      completed_runs: 'Completed',
      failed_runs: 'Failed',
      cancelled_runs: 'Cancelled',
      remaining_to_dispatch: 'Remaining Dispatch',
      remaining_to_complete: 'Remaining Complete',
    },
    listMeta:
      'File: {{file}} · Plates: {{plates}} · Configs: {{configs}} · Qty: {{qty}} · Remaining dispatch: {{remaining}}',
    plateTitle: 'Plate {{index}}',
    platePreviewAlt: 'Plate {{index}} preview',
    plateObjectCount: '{{count}} objects',
    plateObjectsMeta: 'objects={{count}} · est time={{time}} · est filament={{grams}}g',
    estTimeShort: 'Est {{time}}',
    estFilamentShort: '{{grams}}g',
    fingerprint: 'fingerprint',
    gcodeRef: 'G-code ref',
    notAvailable: 'n/a',
    objects: 'Objects',
    noObjects: '—',
    noConfigsForPlate: 'No configs yet for this plate.',
    configMatrix: 'Configuration Matrix',
    plateActions: 'Plate Actions',
    addConfig: 'Add Config',
    qty: 'Qty',
    qtyTotal: 'Qty total',
    qtyDispatched: 'Qty dispatched',
    qtyCompleted: 'Qty completed',
    qtyFailedCancelled: 'Failed/cancelled',
    configLabelOptional: 'Config label (optional)',
    printerModelOptional: 'Printer model (optional)',
    addConfigButton: 'Add Config',
    newConfigNamePlaceholder: 'Modified A (optional)',
    modifiedConfigDefault: 'Modified',
    addConfigSuccess: 'Added config for plate {{plateIndex}}',
    config: 'Config {{code}}',
    configStatusLine:
      'status={{status}} · qty={{qty}} · queued={{queued}} · printing={{printing}} · completed={{completed}} · remaining dispatch={{remaining}}',
    configNamePlaceholder: 'Config name',
    quantityTargetPlaceholder: 'Quantity target',
    requiredPrinterModelOptional: 'Required printer model (optional)',
    slotMappings: 'Slot Mappings',
    slotLabel: 'Slot {{slotIndex}}',
    materialPlaceholder: 'PLA/PETG/ABS',
    colorHexPlaceholder: '#RRGGBB',
    colorFamilyPlaceholder: 'color family',
    nozzlePlaceholder: 'nozzle/tool',
    saveColumn: 'Save Column',
    removeConfig: 'Remove config',
    configRemoved: 'Removed config {{code}}',
    saveSlots: 'Save Slots',
    saveConfig: 'Save Config',
    updatedSlotsSuccess: 'Updated slots for {{code}}',
    savedConfigSuccess: 'Saved config {{code}}',
    dispatchConfigSuccess: 'Dispatched {{count}} item(s) for {{code}}. Remaining: {{remaining}}',
    dispatchPlateSuccess: 'Dispatched {{count}} item(s) for plate {{plateIndex}}. Remaining: {{remaining}}',
    dispatchOrderSuccess: 'Dispatched {{count}} item(s). Remaining order dispatch: {{remaining}}',
    dispatchFailed: 'Dispatch failed',
    invalidQty: 'Quantity must be a non-negative integer.',
    invalidDispatchLimit: 'Dispatch limit must be a positive integer.',
    invalidColorHex: 'Slot {{slotIndex}} color must be a 6-digit hex value (#RRGGBB).',
    saveConfigFailed: 'Failed to save configuration',
    updateConfigFailed: 'Failed to update configuration',
    customer: 'Customer',
    customerPlaceholder: 'Customer name / account',
    saveHeader: 'Save Header',
    headerSaved: 'Order header saved',
    headerSaveFailed: 'Failed to save order header',
    orderNameRequired: 'Order name is required.',
    haltOrder: 'Halt Order',
    resumeOrder: 'Resume Order',
    closeOrder: 'Close Order',
    deleteOrder: 'Delete Order',
    orderHalted: 'Order halted',
    orderResumed: 'Order resumed',
    orderClosed: 'Order closed',
    orderDeleted: 'Order deleted',
    orderActionFailed: 'Order action failed',
    confirmHaltTitle: 'Halt order?',
    confirmHaltMessage: 'Dispatching new queue items will be blocked while the order is halted. Existing queue items remain unchanged.',
    confirmCloseTitle: 'Close order?',
    confirmCloseMessage: 'Closing marks the order as final and stops new dispatch from this order.',
    confirmDeleteTitle: 'Delete order?',
    confirmDeleteMessage: 'This removes the order planning data. Linked historical queue/archive records remain, but order links may be cleared.',
    showNotes: 'Show Notes',
    hideNotes: 'Hide Notes',
    plateProgressLine:
      'completed={{completed}} / {{target}} · queued={{queued}} · printing={{printing}} · remaining dispatch={{remaining}}',
    hiddenCancelledConfigs: '{{count}} cancelled config(s) hidden',
    usedGrams: '{{grams}}g',
    matrix: {
      baseMaterials: 'Base Material / Color',
      original: 'Original',
      originalReadonly: 'Read-only source 3MF mapping',
      rowUsage: 'Matrix',
      configCount: 'Configs',
      baseValue: 'Base',
      overrideValue: 'Config override',
      originalBaseRow: 'Source material/color',
      noOverride: 'No override',
      colorOverride: 'Color override',
      colorPicker: 'Pick override color',
      selectFromInventory: 'Select',
      selectCatalogColor: 'Select Color',
      configProgressLine: 'Q={{queued}} · P={{printing}} · C={{completed}} · R={{remaining}}',
    },
    selector: {
      title: 'Select Filament / Color Override',
      ...
      color: 'Color',
      availableColors: 'Available colors (catalog, filtered by inventory)',
      inStockOnly: 'In stock',
      inventoryOnly: 'Show only inventory-available',
      loading: 'Loading options...',
      noInventoryMatches: 'No inventory spools match the current filters.',
      noDefinitionMatches: 'No filament definitions match the current filters.',
      noCatalogMatches: 'No catalog colors match the current filters.',
      matches: 'matches',
      closestCatalog: 'Closest catalog',
      catalogFallback: 'Unmapped color',
      resetToBase: 'Reset to Base',
      remainingWeight: '{{grams}}g left',
      inventoryTag: 'Spool #{{id}}',
      catalogTag: 'Def #{{id}}',
      catalogColorTag: 'Color #{{id}}',
      inventoryMatches: '{{count}} in inventory',
    },
  },
  ...
  fileManager: {
    ...
    only3mfForOrders: 'Batch Orders can only be created from 3MF files.',
    noPermissionCreateOrder: 'You do not have permission to create orders',
    ...
    toast: {
      ...
      batchOrderCreated: 'Batch order created',
    },
  },
