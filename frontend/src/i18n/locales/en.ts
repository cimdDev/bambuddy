export default {
  ...
  stats: {
    ...
    privatePsiAccounting: 'PSI / Private Accounting',
    privatePsiJobs: 'Private Jobs Share',
    privateCount: '{{count}} private',
    privateWithPartialWeight: 'Private {{private}} • Partial {{partial}}',
    privateWithPartialCost: 'Private {{private}} • Partial {{partial}}',
    psiPercentPrivatePercent: 'PSI {{psi}}% • Private {{private}}%',
    materialWeightSplit: 'Material Weight Split',
    materialCostSplit: 'Material Cost Split',
    psiPrivatePartialWeightValues: 'PSI {{psi}} • Private {{private}} • Partial {{partial}}',
    psiPrivatePartialCostValues: 'PSI {{psi}} • Private {{private}} • Partial {{partial}}',
    psiLabel: 'PSI',
  ...
  printerFiles: {
    ...
    importButton: 'Import to Bambuddy',
    moveButton: 'Move to Bambuddy',
    printButton: 'Print',
    scheduleButton: 'Schedule Print',
    deleteButton: 'Delete',
    ...
    toast: {
      imported: 'Imported {{count}} file(s) into Bambuddy',
      moved: 'Moved {{count}} file(s) into Bambuddy',
      movedPartial: 'Imported {{count}} file(s); some printer files could not be deleted',
      printReady: 'Imported file and opened print flow',
      queueReady: 'Imported file and opened queue flow',
      importFailed: 'Import failed: {{error}}',
      importFailedCount: 'Failed to import {{count}} file(s)',
      moveDeleteFailed: 'Imported file(s), but could not delete {{count}} source file(s)',
