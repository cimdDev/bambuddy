export default {
  ...
  queue: {
    ...
    editSlicerUser: {
      ...
      description: 'Enter the correct user badge for this queued print. You can use a badge name or email address.',
      label: 'User badge',
      ...
      unsupported: 'This queue item cannot be updated',
    },
    accounting: {
      privateJob: 'Private job',
      privateMaterial: 'Private material',
  ...
  uploadModal: {
    ...
    missingUserBadgeWarning: '{{count}} uploaded file is missing a user badge. You can correct it from the queue badge.',
  ...
  editArchive: {
    ...
    accounting: {
      title: 'Accounting',
      privateJob: 'Private job',
      privateMaterial: 'Printed with private material (full)',
      privateMaterialPartial: 'Printed with private material (partially)',
    },
    saving: 'Saving...',
    // Failure reasons
    failureReasons: {
