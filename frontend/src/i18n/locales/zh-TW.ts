export default {
  ...
  queue: {
    ...
    badges: {
      ...
      slicerUserMissingWarning: '請僅使用 AIK 印表機設定檔',
    },
    accounting: {
      privateJob: '私人工作',
      privateMaterial: '私人材料',
  ...
  stats: {
    ...
    privatePsiAccounting: 'PSI / 私人統計',
    privatePsiJobs: '私人工作占比',
    privateCount: '{{count}} 個私人',
  ...
  editArchive: {
    ...
    accounting: {
      title: '核算',
      privateJob: '私人工作',
      privateMaterial: '使用私人材料列印（全部）',
      privateMaterialPartial: '使用私人材料列印（部分）',
    },
    saving: '儲存中...',
    // Failure reasons
    failureReasons: {
